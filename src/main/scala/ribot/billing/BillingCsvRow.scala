...
import ribot.model.{NetworkClass, Classic, Usage, InstanceType}
...
class BillingCsvRow(values: Map[String, String], lineNumber: Long) {
  ...
  // RecordType: LineItem for raw data, AccountTotal for account totals, StatmentTotal, Rounding, InvoiceTotal
  ...
  // ItemDescription: seems pretty forumalic
